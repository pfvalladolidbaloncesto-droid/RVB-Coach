document.addEventListener("DOMContentLoaded", () => {
    ...
    // 4. Manejo de la cámara / archivo con compresión
    ...
    btnEnviar.addEventListener("click", async () => {
        ...
        try {
            ...
            // Envío de la imagen a Google Apps Script usando un formulario oculto clásico
            if (imagenBase64) {
...
});ventListener("click", () => { window.location.href = "menu_principal.html"; }); });
