document.addEventListener("DOMContentLoaded", () => {
  ...
  if (variableActual === "Carga Jugador") {
    ...
    // Si es Carga Equipo, ocultamos el campo de texto extra tal como hacía App Inventor
  ...
  btnEnviarCarga.addEventListener("click", async () => {
    ...
    // Convertir la fecha a formato DD/MM/YYYY si tu Apps Script lo espera así (como en tu App Inventor original)
    // Si tu Apps Script prefiere YYYY-MM-DD, puedes enviar directamente fechaSeleccionada
    ...
    try {
      ...
      // Hacemos la petición GET al Web App de Google (equivalente a Web1.Get en App Inventor)
      const response = await fetch(urlWeb);
      
      // Una vez procesado en Google Sheets, abrimos el PDF correspondiente en otra pestaña (equivalente al ActivityStarter)
      let urlPdf = "";
      if (variableActual === "Carga Jugador") {
        ...
        urlPdf = "https://docs.google.com/spreadsheets/d/1waAXuyLOYY7yp0WQzv17OTOPvcZ4uvsv17OTOPvcZ4uvuhKGkp1YdlOrQ/export?format=pdf&gid=1855641404&range=A1:Q208&size=A4&portrait=true&fitw=true&top_margin=0.5&bottom_margin=0.5&left_margin=0.5&right_margin=0.5";
      }
